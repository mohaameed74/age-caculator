...
function validate(){
    ...
    inputs.forEach((i) => {
        ...
        if (!i.value){
            ...
            monthInp.parentElement.uerySelectoqr("small").innerText ="must be a valid month."
            validator= false;   
        }else if (dayInp.value > 31){
            dayInpInp.style.borderColor="red"
            dayInp.parentElement.uerySelectoqr("small").innerText ="must be a valid day."
            validator= false;   
        }else {
